...
async function R(t, r = _()) {
  const { path: s, matched: e } = r.resolve(t);
  if (
    !e.length ||
    (r._routePreloaded || (r._routePreloaded = new Set()),
    r._routePreloaded.has(s))
  )
    return;
  const n = (r._preloadPromises = r._preloadPromises || []);
  if (n.length > 4) return Promise.all(n).then(() => R(t, r));
  ...
  for (const u of i) {
    const a = Promise.resolve(u())
      .catch(() => {})
      .finally(() => n.splice(n.indexOf(a)));
    n.push(a);
  }
  await Promise.all(n);
}
const M = (...t) => t.find((r) => r !== void 0);
function $(t) {
  ...
  function s(e, n) {
    ...
    const i = "path" in e && e.path !== void 0 ? e.path : n(e).path;
    return { ...e, name: void 0, path: S(i, t.trailingSlash) };
  }
  return V({
    name: r,
    props: {
    ...
    setup(e, { slots: n }) {
      const i = _(),
        ...
        f = b(
          () => typeof a.value == "string" && q(a.value, { acceptRelative: !0 })
        ),
        g = b(() => e.target && e.target !== "_self"),
        p = b(() =>
          e.external || g.value
            ? !0
      ...
      if (
        ...
        F(() => {
          ...
          B(() => {
            h = w(() => {
              var c;
              (c = v == null ? void 0 : v.value) != null &&
                c.tagName &&
                (o = y.observe(v.value, async () => {
                  o == null || o(), (o = null);
                  const m =
                  ...
                  await Promise.all([
                    d.hooks.callHook("link:prefetch", m).catch(() => {}),
                    !p.value && R(a.value, i).catch(() => {}),
                  ]),
                    (x.value = !0);
                }));
            });
      ...
      return () => {
        ...
        if (!p.value) {
          ...
          return (
            e.custom ||
              (x.value && (c.class = e.prefetchedClass || t.prefetchedClass),
              (c.rel = e.rel || void 0)),
            P(H("RouterLink"), c, n.default)
          );
        }
        const l =
            typeof a.value == "object"
              ? ((o = i.resolve(a.value)) == null ? void 0 : o.href) ?? null
              : a.value && !e.external && !f.value
              ? s(N(u.app.baseURL, a.value), i.resolve)
              : a.value || null,
          d = e.target || null,
          h =
            M(
              ...
              f.value || g.value ? "noopener noreferrer" : ""
            ) || null;
        if (e.custom) {
          if (!n.default) return null;
          const c = () => E(l, { replace: e.replace, external: e.external });
          return n.default({
            href: l,
            navigate: c,
            get route() {
    ...
    e = (i, u) => (
      r ||
        (r = new IntersectionObserver((a) => {
          for (const f of a) {
            const g = s.get(f.target);
            (f.isIntersecting || f.intersectionRatio > 0) && g && g();
          }
        })),
      s.set(i, u),
      r.observe(i),
